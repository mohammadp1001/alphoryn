...
def test_rsi_result_is_overbought():
    ...
    r = RSIResult(
        symbol="X", period=14, current=75.0, values=[], is_overbought=True, is_oversold=False
    )
...
def test_rsi_result_is_oversold():
    ...
    r = RSIResult(
        symbol="X", period=14, current=25.0, values=[], is_overbought=False, is_oversold=True
    )
...
def test_ohlcv_data_closes_property():
    ...
    bars = [
        ...
        OHLCVBar(
            timestamp="2025-01-02", open=101.0, high=103.0, low=100.0, close=102.0, volume=1.1e6
        ),
    ]
...
def test_ohlcv_data_volumes_property():
    ...
    bars = [
        OHLCVBar(timestamp="2025-01-01", open=100.0, high=102.0, low=99.0, close=101.0, volume=1e6),
        OHLCVBar(
            timestamp="2025-01-02", open=101.0, high=103.0, low=100.0, close=102.0, volume=2e6
        ),
    ]
